...
movement_detected = False  # Flag to track movement detection
...
while True:
    ...
    # If head movement is detected, set the flag
    if prediction > 0.5:
        movement_detected = True
    else:
        movement_detected = False

    # If head movement is detected, display a warning
    if movement_detected:
        cv2.putText(frame, "Warning: Head Movement Detected!", (10, 70), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
